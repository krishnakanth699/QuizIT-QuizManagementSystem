        ...
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="form1" onsubmit="return validate()">
            <center>
                <div class="login__field">
                    ...
                    <input value="20BCE2633" class="login__input" type="text" name="username" placeholder="Username"
                        title="Registration ID" required />
                </div>
                <br>
                <div class="login__field">
                    <i class="login__icon fas fa-lock"> </i>
                    <input value="arvind123" class="login__input" type="password" name="password" placeholder="Password"
                        pattern="(?=.*\d)(?=.*[a-z]).{8,}"
